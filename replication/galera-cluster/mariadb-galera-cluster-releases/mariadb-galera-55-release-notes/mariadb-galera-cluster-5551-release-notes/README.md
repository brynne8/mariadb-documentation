...
MariaDB Galera Cluster 5.5.51 is a <strong><em>[Stable](/kb/en/release-criteria/)</em></strong> (GA)
release. It is a merge of [MariaDB 5.5.51](/kb/en/mariadb-5551-release-notes/) and
...
- See the [MariaDB 5.5.51 Release Notes](/kb/en/mariadb-5551-release-notes/) and
  [Changelog](/kb/en/mariadb-5551-changelog/) for more information on the changes in
  MariaDB.
...
A full list of all changes is in the [changelog](/replication/galera-cluster/mariadb-galera-cluster-releases/mariadb-galera-55-changelogs/mariadb-galera-cluster-5551-changelog/).
