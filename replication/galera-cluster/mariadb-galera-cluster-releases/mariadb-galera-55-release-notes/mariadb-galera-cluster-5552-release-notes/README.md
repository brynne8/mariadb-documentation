...
MariaDB Galera Cluster 5.5.52 is a <strong><em>[Stable](/kb/en/release-criteria/)</em></strong> (GA)
release. It is a merge of [MariaDB 5.5.52](/kb/en/mariadb-5552-release-notes/) and
...
There was an important security fix included in the MariaDB Galera Cluster 5.5.51 release.<br>Please see the [MariaDB 5.5.51 Release Notes](/kb/en/mariadb-5551-release-notes/) and [this blog post](https://mariadb.org/mariadb-server-versions-remote-root-code-execution-vulnerability-cve-2016-6662/) for more details.
...
- See the [MariaDB 5.5.52 Release Notes](/kb/en/mariadb-5552-release-notes/) and
  [Changelog](/kb/en/mariadb-5552-changelog/) for more information on the changes in
  MariaDB.
...
A full list of all changes is in the [changelog](/replication/galera-cluster/mariadb-galera-cluster-releases/mariadb-galera-55-changelogs/mariadb-galera-cluster-5552-changelog).
