...
MariaDB Galera Cluster 5.5.50 is a <strong><em>[Stable](/kb/en/release-criteria/)</em></strong> (GA)
release. It is a merge of [MariaDB 5.5.50](/kb/en/mariadb-5550-release-notes/) and
...
- The [Galera library](http://codership.com/content/using-galera-cluster) used
  ...
  currently at version <strong>25.3.15</strong>.
...
- See the [MariaDB 5.5.50 Release Notes](/kb/en/mariadb-5550-release-notes/) and
  [Changelog](/kb/en/mariadb-5550-changelog/) for more information on the changes in
  MariaDB.
...
A full list of all changes is in the [changelog](/replication/galera-cluster/mariadb-galera-cluster-releases/mariadb-galera-55-changelogs/mariadb-galera-cluster-5550-changelog).
