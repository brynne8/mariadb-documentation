...
MariaDB Galera Cluster 5.5.47 is a <strong><em>[Stable](/kb/en/release-criteria/)</em></strong> (GA)
release. It is a merge of [MariaDB 5.5.47](/kb/en/mariadb-5547-release-notes/) and
...
[MariaDB Galera Cluster 5.5.47 Changelog](/replication/galera-cluster/mariadb-galera-cluster-releases/mariadb-galera-55-changelogs/mariadb-galera-cluster-5547-changelog).
...
- See the [MariaDB 5.5.47 Release Notes](/kb/en/mariadb-5547-release-notes/) and
  [Changelog](/kb/en/mariadb-5547-changelog/) for more information on the changes in
  MariaDB.
