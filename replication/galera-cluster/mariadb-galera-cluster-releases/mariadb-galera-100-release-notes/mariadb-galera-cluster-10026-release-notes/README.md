...
MariaDB Galera Cluster 10.0.26 is a <strong><em>[Stable](/kb/en/release-criteria/)</em></strong> (GA)
release. It is a merge of [MariaDB 10.0.26](/kb/en/mariadb-10026-release-notes/) and
...
[MariaDB Galera Cluster 10.0.26 Changelog](/replication/galera-cluster/mariadb-galera-cluster-releases/mariadb-galera-100-changelogs/mariadb-galera-cluster-10026-changelog).
...
- As per the [MariaDB Deprecation Policy](/kb/en/deprecation-policy/), this will be the last release of MariaDB Galera Cluster 10.0 for Ubuntu 15.10 "wily"
