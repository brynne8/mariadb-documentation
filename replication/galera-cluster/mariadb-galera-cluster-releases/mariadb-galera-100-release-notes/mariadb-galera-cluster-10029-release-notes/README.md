...
MariaDB Galera Cluster 10.0.29 is a <strong><em>[Stable](/kb/en/release-criteria/)</em></strong> (GA)
release. It is a merge of [MariaDB 10.0.29](/kb/en/mariadb-10029-release-notes/) and
...
[MariaDB Galera Cluster 10.0.29 Changelog](/replication/galera-cluster/mariadb-galera-cluster-releases/mariadb-galera-100-changelogs/mariadb-galera-cluster-10029-changelog/).
For changes made in [MariaDB 10.0.29](/kb/en/mariadb-10029-release-notes/), see the
[MariaDB 10.0.29 Changelog](/kb/en/mariadb-10029-changelog/)
...
- See the [MariaDB 10.0.29 Release Notes](/kb/en/mariadb-10029-release-notes/) and
  [Changelog](/kb/en/mariadb-10029-changelog/) for more information on the changes in
  MariaDB.
