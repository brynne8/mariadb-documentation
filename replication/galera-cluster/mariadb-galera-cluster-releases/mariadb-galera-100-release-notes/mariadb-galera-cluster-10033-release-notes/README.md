...
MariaDB Galera Cluster 10.0.33 is a <strong><em>[Stable](/kb/en/release-criteria/)</em></strong> (GA)
release. It is a merge of [MariaDB 10.0.33](/kb/en/mariadb-10033-release-notes/) and
...
[MariaDB Galera Cluster 10.0.33 Changelog](/replication/galera-cluster/mariadb-galera-cluster-releases/mariadb-galera-100-changelogs/mariadb-galera-cluster-10033-changelog).
For changes made in [MariaDB 10.0.33](/kb/en/mariadb-10033-release-notes/), see the
[MariaDB 10.0.33 Changelog](/kb/en/mariadb-10033-changelog/)
...
- See the [MariaDB 10.0.33 Release Notes](/kb/en/mariadb-10033-release-notes/) and
  [Changelog](/kb/en/mariadb-10033-changelog/) for more information on the changes in
  MariaDB.
