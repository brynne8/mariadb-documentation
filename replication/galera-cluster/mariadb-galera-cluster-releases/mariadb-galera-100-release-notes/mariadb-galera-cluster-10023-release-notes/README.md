...
MariaDB Galera Cluster 10.0.23 is a <strong><em>[Stable](/kb/en/release-criteria/)</em></strong> (GA)
release. It is a merge of [MariaDB 10.0.23](/kb/en/mariadb-10023-release-notes/) and
...
[MariaDB Galera Cluster 10.0.23 Changelog](/replication/galera-cluster/mariadb-galera-cluster-releases/mariadb-galera-100-changelogs/mariadb-galera-cluster-10023-changelog).
...
- See the [MariaDB 10.0.23 Release Notes](/kb/en/mariadb-10023-release-notes/) and
  [Changelog](/kb/en/mariadb-10023-changelog/) for more information on the changes in
  MariaDB.
